...
namespace zc {
   ...
   public:
      ...
      /**
       * Check whether expression has already been computed; if so, assign out value.
       * @return true if has been computed; false otherwise.
       */
      virtual bool DAGCheck(const Value **out, ExprKind mode);
      void DAGClear(ExprKind mode);
      void DAGSet(const z80::VariableValue *var, ExprKind mode);
   ...
   public:
      ...
      virtual bool DAGCheck(const Value **out, ExprKind mode) override;
