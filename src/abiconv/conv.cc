...
namespace {
   ...
   inline T64 convert_arg(const void *& args32, void *& args64, reg_width_t *& argtypes,
                          unsigned& arg_count) {
   ...
   void printf_parse_directive(const void *& args32, void *& args64, reg_width_t *& argtypes,
      ...
      case 'X':
      case 'c':
         convert_arg<int32_t, int32_t>(args32, args64, argtypes, arg_count);
         break;

      case 'D':
      case 'O':
      case 'U':
         convert_arg<int32_t, int64_t>(args32, args64, argtypes, arg_count);
         break;
